...
use App\Http\Controllers\Products\ProductsAnalysisController;



// Main Page Route
Route::get('/', [LoginController::class, 'login'])
    ->name('register');Route::get('/dashboard/analytics', [Analytics::class, 'index'])->name('dashboard-analytics');
...
// Routes of the new assignment task for laravel
...
Route::get('/register/fill-otp', [RegisterController::class, 'fillregistrationotp'])
    ->name('register.fill-otp');

    Route::post('/register/verify-otp', [RegisterController::class, 'verifyOtp'])
    ->name('register.verify-otp');
Route::match(['get', 'post'], '/register/set-password', [RegisterController::class, 'setPassword'])
    ->name('register.setpassword');

Route::get('/dashboard', function () {
    return 'Dashboard loaded for ' . auth()->user()->email;
})->middleware('auth')->name('dashboard');


Route::match(['get', 'post'], '/login', [LoginController::class, 'login'])
    ->name('login');
Route::match(['get', 'post'], '/login/otp', [LoginOtpController::class, 'verify'])
    ->name('login.otp');
...
// Product Routes
    ...
    Route::post('/products', [ProductsController::class, 'store'])
        ->name('products.store');
        Route::post('/products/{id}/toggle-status', 
    [ProductsController::class, 'toggleStatus']
...
Route::get('/products/{id}/edit', [ProductsController::class, 'edit']);
 ...
 Route::post('/save-fcm-token', [\App\Http\Controllers\FcmTokenController::class, 'store'])
        ...
        // Analysis Page APIs
Route::get('/analysis', [ProductsAnalysisController::class, 'view'])
    ->name('analysis');
    Route::middleware('auth')->get(
    '/dashboard/analysis-data',
    [ProductsAnalysisController::class, 'dashboard']
);
Route::get('/dashboard/sales', [ProductsAnalysisController::class, 'sales'])
    ->name('dashboard.sales');
Route::middleware('auth')
    ->get('/dashboard/customers', [ProductsAnalysisController::class, 'customers']);
    Route::middleware('auth')
    ->get('/dashboard/revenue', [ProductsAnalysisController::class, 'revenue']);
    Route::middleware('auth')
    ->get('/dashboard/metrics', [ProductsAnalysisController::class, 'metrics']);
...
Route::get('/debug-save-fcm', function () {
    auth()->user()->update([
